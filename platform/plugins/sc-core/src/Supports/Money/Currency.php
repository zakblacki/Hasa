...
namespace Skillcraft\Core\Supports\Money;

use Skillcraft\Core\Casts\CurrencyCast;
...
class Currency implements Arrayable, Castable, Jsonable, JsonSerializable, Renderable
{
    ...
    {
        $currencies = config('plugins.sc-core.money.currencies', []);

        return static::$currencies ??= $currencies;
    }
